...
:menu
set /a randomwyplatapodatek=(%random% %%1)
if %randomwyplatapodatek% == 0 goto menu3
if %randomwyplatapodatek% == 1 goto menu2

:menu2
set /a randompodatek=(%random% %%1)
if %randompodatek% == 0 goto podatek
if %randompodatek% == 1 goto wyplata
...
:wyplata
set randomwyplata=(%random% %%2)
if %randomwyplata% == 0 goto wyplata1
if %randomwyplata% == 1 goto wyplata2
if %randompodatek% == 2 goto wyplata3

:wyplata1
set /a kasa=kasa+%wyplata1%
goto menu2

:wyplata2
set /a kasa=kasa+%wyplata2%
goto menu2

:wyplata3
set /a kasa=kasa+%wyplata3%
goto menu2

:podatek
set /a podatekm=podatekm+(%mieszkancy%*2)
set /a podatekt=podatekt+(%turysta%*3)
set /a podatek=podatek+(%podatekm%+%podatekt%)
...
echo Wygrywasz gdy zdobedziesz 10 000 mieszkancow lub 100 000 turystow, a przegrywasz gdy pieniadze beda ponizej lob rowne 0
echo Masz 50% na zwykle przejscie do menu lub na sprobowanie swojego szczescia,
echo Masz 50% szans na wyplate (33,(3)% na %wyplata1%$, 33,(3)% na %wyplata2%$, 33,(3)$ na %wyplata3%$)
echo Lub 50% szans na zaplacenie podatku.
echo.
